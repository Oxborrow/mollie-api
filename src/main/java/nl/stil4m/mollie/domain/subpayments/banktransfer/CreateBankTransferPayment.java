...
public class CreateBankTransferPayment extends OptionedCreatePayment<BankTransferOptions> {
    ...
    public CreateBankTransferPayment(@Nonnull BigDecimal amount, @Nonnull String description, @Nonnull String redirectUrl, @Nonnull Optional<String> webhookUrl, @Nullable Map<String, Object> metadata, BankTransferOptions options) {
