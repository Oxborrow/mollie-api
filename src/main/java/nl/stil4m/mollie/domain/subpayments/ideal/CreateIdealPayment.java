...
public class CreateIdealPayment extends OptionedCreatePayment<IdealPaymentOptions> {
    ...
    public CreateIdealPayment(@Nonnull BigDecimal amount, @Nonnull String description, @Nonnull String redirectUrl, @Nonnull Optional<String> webhookUrl, @Nullable Map<String, Object> metadata, @Nonnull IdealPaymentOptions options) {
