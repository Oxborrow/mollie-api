...
public class CreatePayPalPayment extends OptionedCreatePayment<PayPalOptions> {
    ...
    public CreatePayPalPayment(@Nonnull BigDecimal amount, @Nonnull String description, @Nonnull String redirectUrl, @Nonnull Optional<String> webhookUrl, @Nullable Map<String, Object> metadata, @Nonnull PayPalOptions options) {
