...
public class CreateSepaPayment extends OptionedCreatePayment<SepaOptions> {
    ...
    public CreateSepaPayment(@Nonnull BigDecimal amount, @Nonnull String description, @Nonnull String redirectUrl, @Nonnull Optional<String> webhookUrl, @Nullable Map<String, Object> metadata, @Nonnull SepaOptions options) {
