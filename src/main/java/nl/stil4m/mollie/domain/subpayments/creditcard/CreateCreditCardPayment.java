...
public class CreateCreditCardPayment extends OptionedCreatePayment<CreditCardOptions> {
    ...
    public CreateCreditCardPayment(@Nonnull BigDecimal amount, @Nonnull String description, @Nonnull String redirectUrl, @Nonnull Optional<String> webhookUrl, @Nullable Map<String, Object> metadata, @Nonnull CreditCardOptions options) {
