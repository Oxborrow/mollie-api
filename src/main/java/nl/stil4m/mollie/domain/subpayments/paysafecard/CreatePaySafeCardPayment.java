...
public class CreatePaySafeCardPayment extends OptionedCreatePayment<PaySafeCardOptions> {
    ...
    public CreatePaySafeCardPayment(@Nonnull BigDecimal amount, @Nonnull String description, @Nonnull String redirectUrl, @Nonnull Optional<String> webhookUrl, @Nullable Map<String, Object> metadata, @Nonnull PaySafeCardOptions options) {
