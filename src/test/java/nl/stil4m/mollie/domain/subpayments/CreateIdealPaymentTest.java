...
public class CreateIdealPaymentTest {
    ...
    public void testSerialize() throws IOException {
        ...
        String serialized = objectMapper.writeValueAsString(new CreateIdealPayment(new BigDecimal("1.0"), "Description", "redirectUrl", Optional.empty(), metaData, new IdealPaymentOptions("MyIssuer")));
    ...
    public void testSerializeWithWebhookUrl() throws IOException {
        ...
        Map<String, Object> metaData = new HashMap<>();
        metaData.put("mySpecialKey", "value");
        String serialized = objectMapper.writeValueAsString(new CreateIdealPayment(new BigDecimal("1.0"), "Description", "redirectUrl", Optional.of("webhookUrl"), metaData, new IdealPaymentOptions("MyIssuer")));
